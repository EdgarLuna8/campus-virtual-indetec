/* eslint-disable */
// RESULTADOS DE BUSCADOR GENERAL
export default {
  pages: {
    key: "title",
    data: [
      {title: 'Indetec',   url: 'https://www.indetec.gob.mx/index.php',      icon: 'AtSignIcon', is_bookmarked: false},
      {title: 'Inicio', url: '/', icon: 'HomeIcon', is_bookmarked: false},
      {title: 'Nosotros', url: '/acerca-de', icon: 'InfoIcon', is_bookmarked: false},
      {title: 'Ayuda', url: '/ayuda', icon: 'HelpCircleIcon', is_bookmarked: false},
      {title: 'Contacto', url: '/contacto', icon: 'EditIcon', is_bookmarked: false},
    ]
  },
  files: {
    key:"file_name",
