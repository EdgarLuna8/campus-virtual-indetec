<!-- =========================================================================================
  Description: Dropdown de categorías, disponible en navbar, importa HNavMenuGroup, HNavMenuHeader, HNavMenuItem
  Receive: ---
...
<template>
  <ul class="menu-items flex flex-wrap items-center">
    ...
    <contacto-modal :active="activeContacto" @closeContactoModal="activeContacto = false" />
  </ul>
</template>
