...
<template>
  ...
  >
    ...
    <!-- CON 'show-overlay' HAY UN BUG CON PANTALLAS PEQUEÑAS, SE MUESTRA LA PANTALLA GRIS Y NO PERMITE SELECCIONAR -->
    <!-- <div id="content-area" :class="[contentAreaClass, {'show-overlay': bodyOverlay}]"> -->
    <div id="content-area" :class="[contentAreaClass, {'': bodyOverlay}]">
          ...
          <div class="router-content">
            <transition :name="routerTransition">
              ...
              >
                ...
                <!-- <vs-dropdown vs-trigger-click class="ml-auto md:block hidden cursor-pointer">
                  ...
                  <vs-dropdown-menu>
                    <ul class="bordered-items">
                      <li v-for="(item, index) in $route.meta.dropdown" :key="index" class="flex justify-between px-4 py-4 notification cursor-pointer hover:text-primary">
                        <div class="flex items-start">
                          <feather-icon :icon="item.icon" class="inline-block mr-2" svgClasses="w-4 h-4"/>
                          <div class="mx-2">
                            <small class="font-medium block notification-title text-undefined">{{ item.opcion }}</small>
                          </div>
                        </div>
                        </li>
                    </ul>
                ...
                <vs-dropdown v-if="$route.meta.dropdown" vs-trigger-click class="ml-auto md:block hidden cursor-pointer">
                  <vs-button radius icon="icon-settings" icon-pack="feather" />

                  <vs-dropdown-menu class="w-32">
                    <vs-dropdown-item v-for="(item, index) in $route.meta.dropdown" :key="index">
                      <div
